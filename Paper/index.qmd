---
title: "Effects of Marine and Atmospheric Heatwaves on Intertidal Seagrass: Insights from Experimental Spectroradiometry and Satellite Observations"
...
keywords:
  ...
  - Heatwaves 
abstract:
  Seagrasses are critical to coastal ecosystems, providing habitat, stabilizing sediments, and aiding carbon sequestration. Climate change has increased the frequency and intensity of heatwaves, potentially threatening seagrass health. This study investigates the impact of marine and atmospheric heatwaves on the reflectance of the intertidal seagrass *Zostera noltei*. We performed laboratory experiments, exposing seagrass samples to controlled heatwave conditions while measuring hyperspectral reflectance to assess impact over time. We found that heatwaves induced significant declines in seagrass reflectance, particularly in the green and near-infrared regions This corresponded to green leaves turning brown. Furthemore, key vegetation indices, such as the Normalized Difference Vegetation Index (NDVI) and Green Leaf Index (GLI), displayed marked reductions under heatwave stress, with NDVI values decreasing by up to 34% and GLI by 57%. A novel Seagrass Heat Shock Index (SHSI) was developed to identify leaves fading from green to brown color, showing a higher ability to quantify the effect of heatwave exposure on seagrass coloration. This research suggests that changes in spectral reflectance can effectively be used to detect the early impacts of heatwaves on seagrasses, providing a valuable tool for remote sensing-based habitat assessment. Multispectral satellite observations confirmed these findings, showing widespread seagrass leaves turning brown during atmospheric and marine heatwave events in South Brittany, France. Darkened seagrasses were observed in areas within the intertidal zone that were exposed to maximum temperatures of 32°C for more than 13.5 hours a day. This work highlights the need for continuous monitoring of seagrass meadows under the current and future climate regimes, underscoring the potential of remote sensing to capture rapid environmental changes in intertidal zones.
