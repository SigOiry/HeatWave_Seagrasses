...
get_letter_position <- function(img){
  ...
  x <- as.numeric(ext[1]+0.1*ext[2])
  y <- as.numeric(ext[4]-0.1*ext[4])
  
  return(c(x,y))
}

letter_C <- rast("Data/imgs/Tray_low2.png") %>% 
  get_letter_position()

Tray_low <- ggplot()+
  geom_spatraster_rgb(data = rast("Data/imgs/Tray_low2.png"))+
  coord_equal()+
  geom_text(aes(x = letter_C[1],y=letter_C[2], label = "C"), size = 10)+
    theme_void()+
...
letter_D <- rast("Data/imgs/Tray_high.jpg") %>% 
  get_letter_position()

Tray_high <- ggplot()+
  geom_spatraster_rgb(data = rast("Data/imgs/Tray_high.jpg"))+
  coord_equal()+
  geom_text(aes(x = letter_D[1]/2,y=letter_D[2], label = "D"), size = 10)+
    theme_void()+
  theme(axis.text = element_blank(), 
        axis.title = element_blank(), 
        axis.ticks = element_blank(), 
...
letter_B <- rast("Data/imgs/Chamber.jpg") %>% 
  get_letter_position()

Chamber <- ggplot()+
  geom_spatraster_rgb(data = rast("Data/imgs/Chamber.jpg"))+
  coord_equal()+
  geom_text(aes(x = letter_B[1],y=letter_B[2], label = "B"), size = 10)+
    theme_void()+
  theme(axis.text = element_blank(), 
        axis.title = element_blank(), 
        axis.ticks = element_blank(), 
...
letter_A <- rast("Data/imgs/Sampling.jpg") %>% 
  get_letter_position()

Sampling <- ggplot()+
  geom_spatraster_rgb(data = rast("Data/imgs/Sampling.jpg"))+
  coord_equal()+
  geom_text(aes(x = letter_A[1],y=letter_A[2], label = "A"), size = 10)+
    theme_void()+
  theme(axis.text = element_blank(), 
        axis.title = element_blank(), 
        axis.ticks = element_blank(), 
...
letter_E <- rast("Data/imgs/Micasense_mount.jpg") %>% 
  get_letter_position()

micasense <- ggplot()+
  geom_spatraster_rgb(data = rast("Data/imgs/Micasense_mount.jpg"))+
  coord_equal()+
  geom_text(aes(x = letter_E[1],y=letter_E[2], label = "E"), size = 10)+
    theme_void()+
  theme(axis.text = element_blank(), 
        axis.title = element_blank(), 
        axis.ticks = element_blank(), 
...
#   patchwork::area(t = 1, l = 10, b = 20, r = 19),
#   patchwork::area(t = 1, l = 19, b = 20, r = 28),
#   patchwork::area(t = 20, l = 0.5, b = 29, r = 19),
#   patchwork::area(t = 20, l = 19, b = 29, r = 28)
# 
# )

layout1 <- c(
  patchwork::area(t = 1, l = 1, b = 1000, r = 500),
  patchwork::area(t = 1, l = 501, b = 1000, r = 1000),
  patchwork::area(t = 1, l = 1001, b = 1000, r = 1500),
  patchwork::area(t = 1001, l = 1, b = 1500, r = 1000),
  patchwork::area(t = 1001, l = 1001, b = 1500, r = 1500)
...
plot<-Sampling+
  ...
  patchwork::plot_layout(design=layout1, widths = c(1, 1), heights = c(1, 1)) &
  theme(
    plot.margin = unit(c(0, 0, 0, 0), "pt")
  )


ggsave("Paper/Figs/Experimental_design.png",plot, height = 10, width = 10, dpi = 800)
