...
ggsave("Plot_SHSI_exp.svg",plot_SDI, heigh = 5, width = 10)
```
...
Additionally, there was a clear relationship between seagrass emersion time and seagrass darkening (@fig-GAM_Emersion ; @sec-AnnexeC). Seagrass emerged during less than 13 hours a day were not impacted, whereas seagrass emerged during more than 13 hours turned brown with the maximum darkening occuring on seagrass emerged during more than 14.5 hours daily. 
