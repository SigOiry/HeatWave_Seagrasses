...
label <- data.frame(x = c(as.Date("2021-09-01"), as.Date("2021-09-10")),
                    y = c(15.5,15.5),
...
Combined_plot <- ggplot() +
  ...
  geom_vline(xintercept = as.Date("2021-09-10"), linetype = "dashed",linewidth = 1)+
...
all_plot <- ggplot()+
  ...
  geom_text(aes(x = 153, y = -285, label = "2021-09-06"), angle = 90,size = 3, color = "black")+
...
ggsave("Paper/Figs/High_res/Heatwaves_S2_plot.png",all_plot, height = 663.15*5, width = 793*5, unit = "px",bg = "transparent")
