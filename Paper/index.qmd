...
Throughout the experiment, hyperspectral signatures of both the control and treatment seagrasses were taken using an ASD HandHeld 2 equipped with a fiber optic, allowing measurements to be taken directly inside the chamber without opening it. An average of five reflectance spectrum ($R(\lambda)$), each with an integration time of 544 ms, was taken every minute. Every 10 minutes, the fiber optic was switched from one benthic chamber to the other, in order to measure reflectance in both treatment and control. Because light conditions were controlled inside of the chambers, reflectance calibration of the instrument was performed only each morning at the very first moment of low tide using a Spectralon white reference with 99% Lambertian reflectivity. 
...
-   The Mid-Infrared Water Absorption Index (MIWAI, pers. com.) that is design to measure the absorption of the water around 970 nm. The index make the difference between a linear interpolation between 950 and 990 nm and compare that value to the reflectance at 970 nm : 
