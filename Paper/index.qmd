...
- Relation between the exposure time and the impact of the heatwave
...
Seagrass resilience to heatwaves is a multifaceted issue influenced by species-specific traits, geographical location, and the presence of concurrent environmental stressors [@canadell2021ecosystem ; @hatum2024predicting ; @berger2024eelgrass]. Temperate meadows composed of slow-growing, long-lived species, such as *Posidonia*, *Amphibolis*, and *Zostera*, exhibit high vulnerability to climate change-related disturbances. In contrast, smaller, colonizing species typical of tropical regions, including *Halodule*, *Halophila*, and *Syringodium*, demonstrate greater resilience to warming events and marine heatwaves [@o2018seagrass]. 

Furthermore, tidal ranges in temperate regions are generally more pronounced than in tropical areas, reaching over 10 meters in Mont Saint Michel Bay, France. This variation is a key factor for intertidal seagrasses, which are exposed to air for varying durations depending on their position within the intertidal zone and the tidal amplitude. During neap tides, seagrasses in the upper intertidal zone may have only brief periods of submersion or, in some cases, remain emerged, increasing their susceptibility to extreme atmospheric events. Conversely, seagrasses in the lower intertidal zone may experience extended emersion periods, making them more exposed to extreme marine events. Effects of both marine and atmospheric heatwaves can therefore be amplified by the tidal amplitude at the moment the event occurred. 
Intertidal seagrass species, such as *Nanozostera noltei*, also exhibit distinct phenological patterns throughout the year, which become more pronounced at higher latitudes [@davies2024sentinel; @davies2024intertidal]. The timing of extreme events can significantly impact meadow resilience, particularly if they occur during early developmental stages or after the biomass peak has been reached and leaf senescence has begun.
...
This differential resilience is further shaped by environmental factors; seagrass meadows in regions benefiting from tidal cooling or located away from the warmer edges of their geographical ranges tend to experience less heat stress and demonstrate higher shoot densities [@canadell2021ecosystem ; @berger2024eelgrass]. Additionally, the frequency, duration, and intervals between heatwaves significantly affect seagrass biomass and recovery, with extended and frequent heatwaves reducing resilience and complicating recovery processes [@hatum2024predicting]. Seagrasses possess inherent coping mechanisms, including genetic adaptations and physiological acclimation, such as the rapid activation of photo-protective mechanisms and heat-responsive gene expression [@hughes2004genetic ; @reusch2005ecosystem] . However, the accelerated pace of climate change raises concerns about the capacity of these adaptations to keep up with escalating temperatures [@loarie2009velocity]. Management strategies focused on mitigating local stressors, utilizing heatwave-resistant genotypes, and implementing restoration efforts are critical to bolstering seagrass resilience. Despite these challenges, emerging evidence suggests that some seagrass species may adapt to evolving ecological conditions, providing a measure of hope for their persistence in an increasingly warm climate [@canadell2021ecosystem].
