---
title: Effect of Marine and Atmospheric Heatwaves on Reflectance and Pigment Composition of Intertidal *Nanozostera noltei*
...
Monitoring the second derivative at 665 nm ($R''_{665 \, \text{nm}}$) over time reveals a rapid drop in replicates 1 and 3, decreasing by 26 and 54 % respectively after 24 hours (T24) of treatment (@fig-Exp_Spectral_indices, B). After T24 $R''_{665 \, \text{nm}}$ in these replicates stabilizes for the remainder of the experiment. In contrast, replicate 2 shows a slower but more substantial decrease of 110 % by the experiment’s end. Overall, between the start and the end of the experiment, the $R''_{665 \, \text{nm}}$ have decreased by 72 %.
...
- lack of literature about atmospheric heatwaves and intertidal seagrasses
- Relation between the exposure time and the impact of the heatwave- Compare the time of exposure in situ and during the experiment = more than 14h per days in situ whereas during the experiment, seagrasses have been exposed 12h a day

- Sediment Heatwaves

Although extensive research exists on marine heatwaves' effects on subtidal seagrasses, little attention has been given to intertidal regions. This study initiates an exploration of how intertidal seagrasses respond to the dual influence of marine and atmospheric heatwaves, underscoring the need for further investigation in this underexplored area.

## Frequency Intensity of Heatwaves and implication for seagrasses
...
## WORK IN PROGRESS -- Resilation of seagrasses to extrem events
...
The boxplot in @fig-Resilience_of_seagrasses illustrates the seagrass cover (SPC) changes between impacted and non-impacted areas across three dates: 1st of September, 6th of September and 7th of October 2021. Before the heatwave event on the 1st of September, the impacted seagrass patch had a higher SPC compared to non-impacted areas. However, during the event on the 6th September, a noticeable decline in SPC occurred in the impacted patch (@fig-NDVI_GLI_SPC, C and D). ThisOne month post-event, on the 7th of October, the SPC of the impacted seagrasses, which was initially higher, had decreased to a level below that of the non-impacted seagrasses. This shift underscores the long-term impact of extreme events on previously robust seagrass patches, revealing how heatwaves can reverse resilience patterns, leaving once-thriving patches in a weakened state compared to less disturbed areas.

Seagrass resilience to heatwaves is a complex issue influenced by species-specific traits, geographical location, and concurrent environmental stressors [@canadell2021ecosystem; @hatum2024predicting; @berger2024eelgrass]. Temperate meadows composed of slow-growing, long-lived species such as *Posidonia*, *Amphibolis*, and *Zostera* are highly vulnerable to climate change-related disturbances. In contrast, smaller, colonizing species typical of tropical regions, including *Halodule*, *Halophila*, and *Syringodium*, demonstrate greater resilience to warming events and marine heatwaves [@o2018seagrass].

In temperate regions, tidal ranges are generally more pronounced than in tropical areas, reaching over 10 meters in locations like Mont Saint Michel Bay, France. This significant variation affects intertidal seagrasses, which are exposed to air for varying durations depending on their position within the intertidal zone and the tidal amplitude. During neap tides, seagrasses in the upper intertidal zone may experience only brief periods of submersion or may remain emerged, increasing their susceptibility to extreme atmospheric events. Conversely, seagrasses in the lower intertidal zone may undergo extended emersion periods, making them more exposed to extreme marine events. Consequently, the effects of both marine and atmospheric heatwaves can be amplified by tidal amplitude at the time the event occurs.

Intertidal seagrass species such as *Nanozostera noltei* exhibit distinct phenological patterns throughout the year, which become more pronounced at higher latitudes [@davies2024sentinel; @davies2024intertidal]. The timing of extreme events can significantly impact meadow resilience, particularly if they coincide with early developmental stages or occur after the biomass peak has been reached and leaf senescence has begun.

Environmental factors further shape this differential resilience. Seagrass meadows in regions benefiting from tidal cooling or situated away from the warmer edges of their geographical ranges tend to experience less heat stress and exhibit higher shoot densities [@canadell2021ecosystem; @berger2024eelgrass]. Moreover, the frequency, duration, and intervals between heatwaves significantly affect seagrass biomass and recovery; prolonged and frequent heatwaves reduce resilience and complicate recovery processes [@hatum2024predicting].

Seagrasses possess inherent coping mechanisms, including genetic adaptations and physiological acclimation, such as the rapid activation of photoprotective mechanisms and heat-responsive gene expression [@hughes2004genetic; @reusch2005ecosystem]. However, the accelerated pace of climate change raises concerns about the ability of these adaptations to keep pace with escalating temperatures [@loarie2009velocity]. Management strategies focused on mitigating local stressors, utilizing heatwave-resistant genotypes, and implementing restoration efforts are critical for bolstering seagrass resilience. Despite these challenges, emerging evidence suggests that some seagrass species may adapt to evolving ecological conditions, providing hope for their persistence in an increasingly warm climate [@canadell2021ecosystem].
