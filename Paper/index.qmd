...
The second derivative of the reflectance spectra was calculated to retrieve absorption features and compare their variability over time. Two radiometric indices were also monitored throughout the experiment : 
...
-   The Green Leaf Index (GLI, @louhaichi2001spatially), as a measurment of the greenness of seagrass leafs (@eq-gli)

$$
GLI = \frac{[R(550nm)-R(668nm)]+[R(550nm)-R(450nm)]}{(2 \times R(550nm) )+ R(668nm) + R(450nm) }
$$ {#eq-gli}

where $R(668nm)$ is the reflectance in the red at 668 nm, $R(550nm)$ is the reflectance in the green at 550 nm and $R(450)$ is the reflectance in the blue at 450 nm.
