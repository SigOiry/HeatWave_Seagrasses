...
::: {.absolute .fragment .fade-in-then-out fragment-index="5" top="10%" left="55%"}
![](Images/Simon_Sampling.png){height="1000"}
:::

::: {.absolute .fragment .fade-in-then-out fragment-index="5" top="10%" left="75%"}
