...
Intensity_Max = max_light_intensity
  ...
  for (i in 1:2) {
      ...
      df_profile <- df_profile %>% 
        ...
        dplyr::select(-Minute_num) %>% 
        left_join(df_Air_temp, by = "Hour") %>% 
        dplyr::select(-c(Time_num,id)) %>% 
...
test <- Make_Profile(min_Air_Temp_control = 18,
                    ...
                    date_start = "2024-07-02 00:00",
                    date_end = "2024-07-08 23:00",
                    low_tide_time = "2024-07-02 03:00",
                    sunrise = 6.25,
                    sunset = 22,
                    ...
                    time_step = 60, 
                    Save_Experiment = F, 
                    Experiment_Name = "HW2_12072024_to_15072024")
