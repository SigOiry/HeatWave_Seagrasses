...
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio]{Figs/Low_res/Plot_explain_SHSI.png}
...
C: Relative difference of the GLI; E: Relative difference of the SHSI.
...
The SHSI revealed clear distinctions between the Control and Treatment
groups (Figure~\ref{fig-SDI_over_Time}). At day 1, the SHSI of the
