...
remained unchanged (median SPC = 65\%; {[}Figure~\ref{fig-NDVI_GLI_SPC}
C green).
...
\subsection{Frenquency Intensity of Heatwaves and implication for
seagrasses}\label{frenquency-intensity-of-heatwaves-and-implication-for-seagrasses}
...
\subsection{Resilation of seagrasses to extrem
events}\label{resilation-of-seagrasses-to-extrem-events}
