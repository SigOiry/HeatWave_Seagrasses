...
observed value at 740 nm (\textbf{Add a Figure}). This approach
...
nm while the red line represents the SHSI value, mesured ar 740 nm.}
...
seagrass meadow impacted by a heatwave that occured on the 10}
...
after a heatwave (Figure~\ref{fig-quiberonMap}). Seagrass leaves turning
...
meadow. These images allow for visual assessment of vegetation type,
...
the event on September 6

, 2021 and the last one, one month after the events on the 8th of
October 2021. Images were acquired as Level-2 product, in surface
