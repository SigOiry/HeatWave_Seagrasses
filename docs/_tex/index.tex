...
aggregated to daily mean temperatures at each stations. Heatwave
detection was performed using the HeatwaveR package in R
...
severity of each event has beeen assed using the methodology proposed by
\citep{hobday2018categorizing}.
...
white reference with 99\% Lambertian reflectivity.

The second derivative of the reflectance spectra was calculated to
retrieve absorption features and compare their variability over time.
...
reflectance in the blue at 450 nm.
