...
Seagrass was sampled from a \emph{Zostera noltei} (dwarf eelgrass, syn.
\emph{Zostera noltei}) meadow on Noirmoutier Island, France
...
The unique reflectance properties of seagrasses under heat stress
facilitate the detection of this stress through remote sensing
...
Pleiades-Neo, WorldView-3, SkySat, and GeoSat-2. Additionally, it will
be compatible with upcoming missions such as Sentinel-2 Next Generation
and Landsat Next. However, satellite remote sensing is often limited by
cloud cover, and because heatwave-induced leaf darkening can occur
rapidly---sometimes within a day or two of the onset of heat
stress---satellites may miss these events. To address this limitation,
drone-based remote sensing offers a valuable alternative, as drones can
be deployed quickly following extreme temperature events, providing
timely and high-resolution multispectral observations of these darkening
events.
