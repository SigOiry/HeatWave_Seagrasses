...
\tightlist
\item
  Tides in temperate regions are more pronounced and so seagrasses are
  more exposed to atmospheric events whereas in tropical -\textgreater{}
  no tides no effect the atmo. furethemore, in temperate regions,
  seagrass have a marked phenology that is less pronounced towards lower
  latitudes.
\end{itemize}
