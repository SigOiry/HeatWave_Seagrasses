...
The boxplot in Figure~\ref{fig-Resilience_of_seagrasses} illustrates the
seagrass cover (SPC) changes between impacted and non-impacted areas
across three dates: 1st of September, 6th of September and 7th of
October 2021. Before the heatwave event on the 1st of September, the
impacted seagrass patch had a higher SPC compared to non-impacted areas.
However, during the event on the 6th September, a noticeable decline in
SPC occurred in the impacted patch (Figure~\ref{fig-NDVI_GLI_SPC}, C and
D). ThisOne month post-event, on the 7th of October, the SPC of the
impacted seagrasses, which was initially higher, had decreased to a
level below that of the non-impacted seagrasses. This shift underscores
the long-term impact of extreme events on previously robust seagrass
patches, revealing how heatwaves can reverse resilience patterns,
leaving once-thriving patches in a weakened state compared to less
disturbed areas.

Seagrass resilience to heatwaves is a complex issue influenced by
...
2021}; \citeproc{ref-hatum2024predicting}{Hatum et al., 2024}).
Temperate meadows composed of slow-growing, long-lived species such as
\emph{Posidonia}, \emph{Amphibolis}, and \emph{Zostera} are highly
vulnerable to climate change-related disturbances. In contrast, smaller,
colonizing species typical of tropical regions, including
\emph{Halodule}, \emph{Halophila}, and \emph{Syringodium}, demonstrate
greater resilience to warming events and marine heatwaves
(\citeproc{ref-o2018seagrass}{O'Brien et al., 2018}).

In temperate regions, tidal ranges are generally more pronounced than in
tropical areas, reaching over 10 meters in locations like Mont Saint
Michel Bay, France. This significant variation affects intertidal
seagrasses, which are exposed to air for varying durations depending on
their position within the intertidal zone and the tidal amplitude.
During neap tides, seagrasses in the upper intertidal zone may
experience only brief periods of submersion or may remain emerged,
increasing their susceptibility to extreme atmospheric events.
Conversely, seagrasses in the lower intertidal zone may undergo extended
emersion periods, making them more exposed to extreme marine events.
Consequently, the effects of both marine and atmospheric heatwaves can
be amplified by tidal amplitude at the time the event occurs.

Intertidal seagrass species such as \emph{Nanozostera noltei} exhibit
distinct phenological patterns throughout the year, which become more
pronounced at higher latitudes (\citeproc{ref-davies2024sentinel}{Davies
et al., 2024a}, \citeproc{ref-davies2024intertidal}{2024b}). The timing
of extreme events can significantly impact meadow resilience,
particularly if they coincide with early developmental stages or occur
after the biomass peak has been reached and leaf senescence has begun.

Environmental factors further shape this differential resilience.
Seagrass meadows in regions benefiting from tidal cooling or situated
away from the warmer edges of their geographical ranges tend to
experience less heat stress and exhibit higher shoot densities
(\citeproc{ref-berger2024eelgrass}{Berger et al., 2024};
\citeproc{ref-canadell2021ecosystem}{Canadell and Jackson, 2021}).
Moreover, the frequency, duration, and intervals between heatwaves
significantly affect seagrass biomass and recovery; prolonged and
frequent heatwaves reduce resilience and complicate recovery processes
(\citeproc{ref-hatum2024predicting}{Hatum et al., 2024}).

Seagrasses possess inherent coping mechanisms, including genetic
adaptations and physiological acclimation, such as the rapid activation
of photoprotective mechanisms and heat-responsive gene expression
(\citeproc{ref-hughes2004genetic}{Hughes and Stachowicz, 2004};
\citeproc{ref-reusch2005ecosystem}{Reusch et al., 2005}). However, the
accelerated pace of climate change raises concerns about the ability of
these adaptations to keep pace with escalating temperatures
(\citeproc{ref-loarie2009velocity}{Loarie et al., 2009}). Management
strategies focused on mitigating local stressors, utilizing
heatwave-resistant genotypes, and implementing restoration efforts are
critical for bolstering seagrass resilience. Despite these challenges,
emerging evidence suggests that some seagrass species may adapt to
evolving ecological conditions, providing hope for their persistence in
an increasingly warm climate
(\citeproc{ref-canadell2021ecosystem}{Canadell and Jackson, 2021}).
