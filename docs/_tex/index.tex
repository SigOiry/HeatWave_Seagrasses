...
Since January 1, 2024, Meteo France weather data has been free and
openly accessible. Hourly weather data for the French coast of the
Atlantic and the Channel has been downloaded using a
\href{https://github.com/SigOiry/HeatWave_Seagrasses/blob/main/MeteoFrance_Extraction.qmd}{custom
script}, as no API has been developed for downloading this data. Weather
stations located within 10 kilometers of the coastline were considered,
but only those with a minimum of 30 years of data were included to
ensure accurate climatology reconstruction. Among the 156 weather
station that are within the 10km threshold of coastline, 36 had enought
data to reconstruct the climatology. Hourly data has been aggregated to
