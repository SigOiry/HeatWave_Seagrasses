...
\phantomsection\label{cell-fig-Temp_plot_S2}
\begin{figure}[H]

\centering{

\includegraphics[width=1\textwidth,height=\textheight]{Figs/Low_res/SST_Air_S2.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{Figs/High_res/S2_Hugo.png}
