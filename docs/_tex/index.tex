...
\hypersetup{
  pdftitle={Heatwaves's impact on intertidal seagrass reflectance: from laboratory experiment to satellite mapping of seagrass heat shock index},
...
\title{Heatwaves's impact on intertidal seagrass reflectance: from
